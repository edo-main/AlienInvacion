...
- **Сделать постоянную стрельбу при удержании кнопки**
- **Правильная работа меню и пауз**

## Обновления
### v0.2.5
- **Появился новый тип вражеского корабля с хп**
- **Добавлена кнопка настроек в меню**
