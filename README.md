...
**Мелкие изменения в управлении** - Escape для пазы и продолжения игры  
...
- **Доработка звуков**
- **Переход на стандартный звуковой модуль Pygame**
- **Добавить кнопку выход**

## Обновления
### v0.1.2
- Изменена логика управления на более удобную
- Добавленны и доработанны звуки и их вариации

## Технические детали

В игре используется библиотека "playsound3" вместо стандартного звукового модуля Pygame. Это связано с некоторыми проблемами на моей системе.
