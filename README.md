...
**Динамичный фон** - соотвествует темпу игры

**Случайные движения инопланетян** - усовершенствованно стандартное перемещение сеткой  

**Разные типы вражеских кораблей** - теперь у противника есть хп
...
- **Добавить глобальные рекорды, которые сохраняются даже если закрыть игру**
- **Добавить стрельбу пративника**
- **Добавить бонус "Временная скорострельность"**

## Обновления
### v0.2.5
- **Появился динамичный фон**
- **Исправления меню**
- **Стрельба по удержанию**
